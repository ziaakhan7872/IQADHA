...
let abc;
const HijriLogs = ({ setScrollView, scrollView, colors }) => {
            ...
            <View style={[styles.mainContainer,{backgroundColor:colors.background}]}>
              ...
              >
                <View style={styles.cardview}>
                  <View>
                    <Text
                      style={[styles.monthsnamJan, { color: colors.textColor }]}
                    >
            ...
            {shouldShow && index == index1 ? (
              <View style={styles.openCard}>
                ...
                <ScrollView
                  ...
                  style={{ height: 100 }}
                >
                  {daysNumber.map((item, index) => {
                    return (
                      <View
                        style={[
                          styles.cardContaniner,
            ...
            <View style={[styles.mainContainer,{backgroundColor:colors.background}]}>
              ...
              >
                <View style={styles.cardview}>
                  <View>
                    <View>
                      <Text style={[styles.monthsName,{color:colors.textColor}]}>
                        {monthArray[index].month}
                      </Text>
                      <Text style={styles.number}>{item.totalNamaz}</Text>
                    </View>
                    ...
                    return (
                      <View style={styles.cardContaniner}>
                        ...
                        <Text
                          style={[styles.text, { color: colors.textColor }]}
                        >
                          {extractNamazByName("Dhuhr", item.namazData).length >
                          0
                        ...
                        <Text
                          style={[styles.text, { color: colors.textColor }]}
                        >
                          {extractNamazByName("Maghrib", item.namazData)
                            .length > 0
                            ? extractNamazByName(
                                "Maghrib",
                                item.namazData
                        ...
                        <Text
                          style={[styles.text, { color: colors.textColor }]}
                        >
                          {extractNamazByName("Ishaa", item.namazData).length >
                          0
